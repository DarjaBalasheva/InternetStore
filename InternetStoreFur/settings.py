"""
Django settings for InternetStoreFur project.
...
SECRET_KEY = "django-insecure-+v0qljut^yf#rt36#0a3n4i^zs8he#@)5d^vrxuh4db9fydtgz"
...
ROOT_URLCONF = "InternetStoreFur.urls"
...
WSGI_APPLICATION = "InternetStoreFur.wsgi.application"
