...
class Category(models.Model):
    ...
    parent = models.ForeignKey('self', on_delete=models.CASCADE, null=True, blank=True)  # Родительская категория
...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, default='29b5de09-979a-47d5-a988-a4678cd8bdde')
